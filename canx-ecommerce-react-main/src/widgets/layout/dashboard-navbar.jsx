    ...
    >
      <div className="flex flex-col-reverse justify-between gap-6 md:flex-row md:items-center">
        <div className="capitalize">
          <Breadcrumbs
            className={`bg-transparent dark:text-gray-300 p-0 transition-all ${fixedNavbar ? "mt-1" : ""
              }`}
          >
            <Link to={`/${layout}`}>
              <Typography
                variant="small"
                color="blue-gray"
                className="font-normal opacity-50 transition-all hover:text-blue-500 hover:opacity-100 dark:text-gray-300"
              >
                {layout}
              </Typography>
            </Link>
        ...
        <div className="flex items-center">
          ...
          {/* {!isDarkMode ? (
            ...
            >
              <MdOutlineWbSunny
                title="lightmode"
                className=" text-[22px] cursor-pointer dark:text-gray-300"
              />
            </IconButton>
          ) : (
            <IconButton
            ...
            >
              <IoMoonSharp
                title="darkmode"
                className=" text-[19px] cursor-pointer dark:text-gray-300"
              />
            </IconButton>
          )}
          <IconButton
