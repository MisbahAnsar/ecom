...
import { RiExchangeFundsLine } from "react-icons/ri"; // Exchange icon
import {
  FaMoneyBillWave, // Icon for Cash Discounts
  FaPercentage, // Icon for Interest
} from "react-icons/fa";
...
import CashDiscounts from "./pages/dashboard/CashDiscounts";
import Interests from "./pages/dashboard/Interests";
import AvailSchemes from "./pages/dashboard/AvailSchemes";
...
export const routes = [
  {
    ...
    pages: [
      ...
      },
      {
        ...
        name: "Avail Schemes",
        path: "/schemes/avail",
        element: <AvailSchemes />,
      },
      {
        icon: <FaMoneyBillWave {...icon} />,
        name: "Cash Discounts",
        path: "/cash-discounts",
        element: <CashDiscounts />,
      },
      {
        icon: <FaPercentage {...icon} />,
        name: "Interest",
        path: "/interest",
        element: <Interests />,
      },
